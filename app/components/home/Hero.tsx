    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="hero-title text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6">
            Cada línea, un concepto;<br />
          ...
          <p className="hero-subtitle text-lg md:text-xl text-white/90 mb-12 max-w-2xl mx-auto font-light">
            Somos la especialidad de la arquitectura que inspira, con la<br />
